    ...
    return (
        ...
        <section class="mt-96">
            ...
            <div class="mt-5 mx-20 grid grid-cols-3 gap-10">
                <div class="bg-white border rounded-md max-w-md">
                    ...
                    <div class="font-semibold text-sm mx-4 mt-2 ">92,372 likes</div>
                    <p class="mx-4">mwt The game in Qatar was amazing and I want to share some photos</p>
                    <p class="text-[#00000066] mx-4 mb-4">September 19</p>
                </div>
                <div class="bg-white border rounded-md max-w-md">
                    <div class="flex items-center px-4 py-3">
                        <img class="h-8 w-8 rounded-full" src="https://picsum.photos/id/1027/150/150" />
