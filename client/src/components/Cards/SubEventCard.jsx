...
const SubEventCard = () => {
    return (
        <>
            <div className=" my-3 flex w-80 md:w-72 p-3 border border-2 rounded-lg space-x-5 justify-between items-center align-middle hover:bg-[#C0A04C] hover:text-white cursor-pointer drop-shadow-2xl">
                <div className="image">
