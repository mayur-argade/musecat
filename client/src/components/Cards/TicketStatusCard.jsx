...
const TicketStatusCard = ({data}) => {
    return (
        <>
            <div class="dark:text-white relative md:m-3 h-auto w-54 md:w-44 lg:w-72 bg-[#F3F3F3] border border-gray-200 rounded-lg shadow dark:bg-[#454545] dark:border-[#454545]">
