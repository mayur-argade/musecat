...
const WhereToMapCard = () => {
    return (
        <>
            <div className="flex max-w-md p-3 border border-2 rounded-lg space-x-5 justify-between items-center align-middle hover:bg-[#C0A04C] hover:text-white cursor-pointer mt-5 drop-shadow-2xl">
                <div className="image">
