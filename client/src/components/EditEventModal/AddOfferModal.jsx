                            ...
                            <div className="dark:bg-[#2c2c2c] dark:text-white modal bg-white px-10 py-5">
                                ...
                                <div className="flex space-x-2 align-middle ml-2 mt-1 mb-3">
                                    <label className="block">
                                        <input type="checkbox" className="w-4 h-4 rounded text-[#A48533] focus:ring-[#A48533]" name="recurring" id="recurring" checked={!datetype} onChange={((e) => setDatetype(!e.target.checked))} />
                                                    ...
                                                    days.map((day, index) => (
                                                        <div className='mx-2'>
                                                            <label key={index} className="block">
                                                                <input
                                                                    className='rounded-sm mr-1 text-[#A48533] focus:ring-[#A48533]'
                                                                    type="checkbox"
                                                                    value={day}
                                ...
                                <label className="relative inline-flex items-center mb-5 cursor-pointer">
                                    ...
                                    />
                                    <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-[#454545] peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                ...
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-[#E7E7E7] dark:text-gray-400 focus:outline-none dark:bg-[#454545] dark:border-gray-600 dark:placeholder-gray-400 mb-1"
                                ...
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-[#E7E7E7] dark:text-gray-400 focus:outline-none dark:bg-[#454545] dark:border-gray-600 dark:placeholder-gray-400 mb-1" id="file_input"
                                ...
                                </div><input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-[#E7E7E7] dark:text-gray-400 focus:outline-none dark:bg-[#454545] dark:border-gray-600 dark:placeholder-gray-400 mb-1" id="file_input"
                                    accept="video/*"
