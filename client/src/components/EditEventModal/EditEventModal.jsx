...
const EditEventModal = ({ onClose, data }) => {
    ...
    const [shortDesc, setShortDesc] = useState(undefined)
    const [datetype, setDatetype] = useState(true)
    const [startDate, setStartDate] = useState(data.date.dateRange.endDate)
    const [endDate, setEndDate] = useState(data.date.dateRange.endDate)
    const [selectedDays, setSelectedDays] = useState(data.date.recurring);
    ...
    const [seatingMap, setSeatingMap] = useState(undefined)
    ...
    const handleSave = async () => {
        ...
        console.log(photo, seatingMap, banner)
                                            ...
                                            <div className="flex align-middle items-center  w-full mt-2 space-x-4">
                                                <div className="flex w-full row1 space-x-4 ">
                                                    <div className='w-full  flex flex-col bg-[#E7E7E7] pl-2 pr-2 rounded-lg'>
                                                        ...
                                                        <input
                                                            type="datetime-local"
                                                            defaultValue={data.date.dateRange.startDate}
                                                            min={minDateTime}
                                                            id="session-date"
...

                                    {
                                        data.type == 'offer'
                                            ...
                                            <div className='mt-3 flex flex-col bg-[#E7E7E7] pl-2 pr-2 rounded-lg'>
                                                ...
                                                <input
                                                    type="number"
                                                    defaultValue={data.discountOnApp}
                                                    className='px-0 py-0.5 w-full border bg-transparent border-[#E7E7E7] focus:border-transparent focus:ring-transparent  outline-0 placeholder:text-sm font-medium '
                                                    placeholder='10'
