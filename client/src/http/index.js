...
export const GetVendorNotification = (data) => api.patch(`notification/all`, data)
...
export const GetVendorUnreadNotification = (data) => api.get('vendor/notification/count', data)
...
export const VendorResendVerificationLink = (data) => api.post("auth/vendor/resend-verification-link", data)
...
export const ClientUpcomingEvents = (data) => api.get(`events/upcoming-events`, data)
