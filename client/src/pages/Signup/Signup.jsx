    ...
    return (
        <section class="h-screen bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/mayurs-media/image/upload/v1692780548/mwt/signup_kwjykh.jpg')] md:bg-gray-400 md:bg-blend-multiply ">
            ...
            <section class="flex flex-col space-y-2 justify-center items-center h-screen md:mt-0 mt-0 m-10">
                <div className="title">
                    <img className='h-6 md:h-8' src="/images/logo/login-logo.png" alt="" />
                </div>

                <div class="max-w-md w-full bg:white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 md:bg-white rounded-lg p-4 space-y-4 border border-white">
                    <div class="mb-4">
                        <h2 class="text-xl font-bold text-white md:text-black">Hello there</h2>
                    </div>
                    <div>
                        <input class="w-full p-4 text-sm bg-white md:bg-gray-100 focus:outline-none border border-gray-200 rounded-md text-gray-600" type="email" for="email" id='email' placeholder="Email" />
                    </div>

                    <div>
                        <input class="w-full p-4 text-sm bg-white md:bg-gray-100 focus:outline-none border border-gray-200 rounded-md text-gray-600" type="text" for="username" id='username' placeholder="Username" />
                    </div>

                    <div>
                        <input class="w-full p-4 text-sm bg-white md:bg-gray-100 focus:outline-none border border-gray-200 rounded-md text-gray-600" type="password" for="password" id='password' placeholder="Password" />
                    </div>

                    <div>
                        <input class="w-full p-4 text-sm bg-white md:bg-gray-100 focus:outline-none border border-gray-200 rounded-md text-gray-600" type="password" for="password" id='password' placeholder="Confirm Password" />
                    </div>
                    <div>
                        <span className='text-white text-xs font-light md:font-regular md:text-slate-400 md:text-sm'>
                            (Optional) if you wish to receive updates on whatsapp
                        </span>
                        <div>
                        <input class="w-full p-4 text-sm bg-white md:bg-gray-100 focus:outline-none border border-gray-200 rounded-md text-gray-600" type="text" for="text" id='text' placeholder="Mobile Number" />
                    </div>
                    </div>
