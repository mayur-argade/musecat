        ...
        const fetchdata = async () => {
            try {
                ...
                setAccordions([
                    ...
                    {
                        title: 'Contact Us',
                        content: (<div className='flex space-x-3 mt-2 mb-2'>
                            <a href={`https://wa.me/+96891738405?text=I'm interested in the event ${data.data.eventDetails.title} and would like more information`} target="_blank" rel="noopener noreferrer">
