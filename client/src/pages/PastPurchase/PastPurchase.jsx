                    ...
                    <div class="filterbyfeature mr-5">
                        <div className="relative inline-block text-left">
                            <button
                                ...
                                className="flex justify-around align-middle border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-40 md:w-44 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                                <img src="/images/icons/filter.svg" alt="" />
                                <p className='text-gray-500 '>Filter by Features</p>
                            </button>
                            {isOpen && (
                                <div
